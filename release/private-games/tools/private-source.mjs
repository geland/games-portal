...
export const PRIVATE_REPOSITORIES = new Map([
  ["butts", "geland/butts"],
  ["lines-drawn", "geland/lines-drawn"],
...
const PRIVATE_WORKFLOWS = new Map([
  ...
  ["lines-drawn", { path: ".github/workflows/release.yml", name: "Build game release candidate", packageStyle: "standard" }],
